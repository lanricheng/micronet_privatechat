package com.vdunpay.vchat.searchview.adapter;
...
public class SearchAdapter extends BaseAdapter implements Filterable {
    ...
    public SearchAdapter(Context application, List<User> list) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.activity_contactitem, null);
...
//                    final String valueText = value.toString().toLowerCase();
        ...
        protected void publishResults(CharSequence prefix, FilterResults results) {
            ...
            mlist = (List<User>) results.values;//此时，Adapter数据源就是过滤后的Results
            if (results.count > 0) {
